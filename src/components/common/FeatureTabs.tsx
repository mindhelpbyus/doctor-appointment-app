...
const features = [
  {
    ...
    icon: Calendar,
    imageUrl: 'https://images.unsplash.com/photo-1587854692152-cbe660fc9717?auto=format&fit=crop&w=500&q=80', // Simplified URL
  },
  {
    value: 'payments',
    ...
    icon: CreditCard,
    imageUrl: 'https://images.unsplash.com/photo-1579621970795-87facc2f976d?auto=format&fit=crop&w=500&q=80', // Simplified URL
  },
  {
    value: 'marketing',
    ...
    icon: Megaphone,
    imageUrl: 'https://images.unsplash.com/photo-1557804506-669a67965da9?auto=format&fit=crop&w=500&q=80', // Simplified URL
  },
  {
    value: 'reporting',
    ...
    icon: BarChart3,
    imageUrl: 'https://images.unsplash.com/photo-1551288259-cd11ad771f6f?auto=format&fit=crop&w=500&q=80', // Simplified URL
  },
  {
    value: 'staff',
    ...
    icon: Users,
    imageUrl: 'https://images.unsplash.com/photo-1519085360753-af0f3899cd5b?auto=format&fit=crop&w=500&q=80', // Simplified URL
  },
];
