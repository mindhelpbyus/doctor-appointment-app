...
export interface Doctor {
  id: string;
  fullName: string;
  avatarUrl: string; // Replaces photoUrl
  gender: 'male' | 'female';
  npi: string;
...
export const doctors: Doctor[] = [
  ...
  // Demo Doctor for Agency
  { id: 'doc-demo', fullName: 'Dr. Demo', avatarUrl: 'https://ui-avatars.com/api/?name=Demo+Doctor&background=random', gender: 'male', npi: '1112229999', type: 'agency', specialtyId: 'spec-1', agencyId: 'agency-1', biography: 'A demonstration doctor for the agency dashboard.', rating: 5.0, yearsExperience: 10, availability: [], weeklyAvailability: defaultWeeklyAvailability, videoConsultation: true, languages: ['English'], clinicAddress: '123 Health St, Greensville', phone: '555-100-9999', email: 'doctor@demo.com' },
];
