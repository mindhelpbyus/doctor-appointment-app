...
export const doctors: Doctor[] = [
  ...
  { id: 'doc-6', fullName: 'Dr. David Green', photoUrl: 'https://via.placeholder.com/150/2563EB/FFFFFF?text=DG', npi: '1112223336', type: 'agency', specialtyId: 'spec-5', agencyId: 'agency-2', biography: 'Head of Neurology, specializing in the treatment of stroke, epilepsy, and other complex neurological conditions.', rating: 4.8, yearsExperience: 20, availability: [{ date: '2024-11-14', slots: ['11:00'] }], weeklyAvailability: defaultWeeklyAvailability, videoConsultation: true, languages: ['English', 'German'], clinicAddress: '456 Metro Ave, Central City', phone: '555-200-2002', email: 'david.green@cgh.com' },
