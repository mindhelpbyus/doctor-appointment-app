...
const AboutUsPage: React.FC = () => {
  return (
    <div className="container mx-auto py-12 px-4">
      <h1 className="text-5xl font-recoleta font-bold text-center text-foreground mb-8">About Docsy</h1>
      <p className="text-center text-lg text-muted-foreground font-averta max-w-3xl mx-auto mb-12">
        Docsy is a flagship product of Bedrock Health Solution, designed to revolutionize how patients connect with healthcare providers. We are committed to building a healthier future by making quality care accessible, efficient, and compassionate for everyone.
      </p>

      <div className="grid md:grid-cols-2 gap-12 items-center">
        <div className="space-y-6">
          <h2 className="text-3xl font-recoleta font-semibold text-foreground">Our Vision for Docsy</h2>
          <p className="text-lg text-muted-foreground font-averta">
            Docsy envisions a world where finding the right healthcare provider is simple, transparent, and stress-free. We aim to be the leading platform for integrated healthcare, empowering individuals to take control of their health journey and fostering a vibrant community of dedicated medical professionals. Through innovative technology, Docsy streamlines appointment booking, communication, and patient management, ensuring a seamless experience for both patients and providers.
          </p>
        </div>
        <div className="flex justify-center">
          <div className="w-full max-w-md h-64 bg-gradient-to-br from-primary to-accent rounded-lg shadow-lg flex items-center justify-center text-white text-xl font-bold">
            <span className="font-recoleta">Docsy: Connecting Care</span>
          </div>
        </div>
      </div>
      ...
      <div className="mt-16 text-center">
        ...
        <p className="text-lg text-muted-foreground font-averta max-w-3xl mx-auto mb-12">
          Bedrock Health Solution is a pioneering company dedicated to developing cutting-edge technology solutions for the healthcare industry. With a focus on innovation, reliability, and user-centric design, we strive to create products that enhance patient care, optimize operational efficiency for providers, and ultimately contribute to a healthier global community. Docsy is a testament to our commitment to transforming healthcare delivery.
        </p>
