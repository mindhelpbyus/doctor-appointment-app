      ...
      <Card className="w-full max-w-md rounded-2xl shadow-medium border-none bg-background p-6"> {/* Enhanced card styling */}
        ...
        <CardContent className="space-y-6"> {/* Increased spacing */}
          <div className="space-y-2">
            ...
            <Input id="name" type="text" placeholder="John Doe" required className="rounded-md border-granite focus:border-primary text-foreground placeholder:text-stone font-averta px-4 py-2" /> {/* Refined input styling */}
          </div>
          <div className="space-y-2">
            <Label htmlFor="email" className="font-averta text-foreground text-sm font-semibold">Email</Label> {/* Semibold label */}
            <Input id="email" type="email" placeholder="m@example.com" required className="rounded-md border-granite focus:border-primary text-foreground placeholder:text-stone font-averta px-4 py-2" /> {/* Refined input styling */}
          </div>
          <div className="space-y-2">
            <Label htmlFor="password" className="font-averta text-foreground text-sm font-semibold">Password</Label> {/* Semibold label */}
            <Input id="password" type="password" required className="rounded-md border-granite focus:border-primary text-foreground placeholder:text-stone font-averta px-4 py-2" /> {/* Refined input styling */}
          </div>
          <div className="space-y-2">
            ...
            <Input id="confirm-password" type="password" required className="rounded-md border-granite focus:border-primary text-foreground placeholder:text-stone font-averta px-4 py-2" /> {/* Refined input styling */}
          </div>
          ...
          <p className="text-center text-sm text-muted-foreground font-averta pt-2"> {/* Added top padding */}
            ...
            <Link to="/login" className="text-primary hover:text-dark-health-blue font-semibold">Login</Link> {/* Semibold link */}
          </p>
        </CardContent>
      </Card>
    </div>
