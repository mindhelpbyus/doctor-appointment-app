...
import { reviews, Review } from '@/data/reviews'; // Import reviews
...
const seedAllData = () => {
  ...
  seedEntity('reviews', reviews); // Seed reviews
...
export const getReviews = (): Review[] => getEntity<Review>('reviews'); // Get all reviews
